...
> 🚀 Built with [Soft UI Dashboard Generator](https://appseed.us/generator/soft-ui-dashboard/), timestamp `2022-08-17 13:09`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cbee136d-7602-4d73-a090-6def72d508d6.git
$ cd cbee136d-7602-4d73-a090-6def72d508d6
```
